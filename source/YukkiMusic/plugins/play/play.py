...
@app.on_message(command(["play", "vplay", "cplay", "cvplay", "playforce", "vplayforce", "cplayforce", "cvplayforce", "شغل" ,"ق تشغيل" , "فيديو", "ق شغل" ,"تشغيل", "/play", "/vplay", "cplay", "cvplay", "/شغل", "/تشغيل", "/ق تشغيل", "/ق شغل", "/فيديو", "شغل يا قلبي"])
     & ~BANNED_USERS          
)
@PlayWrapper
