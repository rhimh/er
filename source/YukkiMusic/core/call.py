    ...
    async def join_call(
        ...
        try:
            ...
            try:
                ...
                raise AssistantErr(
                    "**لا يوجد مكالمه مفتوحه**\n\nتأكد ان المكالمه مفتوحه. اذا كانت مفتوحه وواجهتك هالمشكله, قفلها وارجع افتحها اذا استمرت المشكله اكتب ريستارت , لو ما اشتغلت ضيف المساعد يدوي"
                )
        except AlreadyJoinedError:
            raise AssistantErr(
                "**المساعد موجود بالمكالمه مسبقا**\n\nيبدو ان المساعد موجود بالفعل في المكالمه, هالمشكله تظهر اذا استخدمت امرين مع بعض.\n\nاذا واجهتك مشكله قفل المكالمه واكتب ريستارت وارجع افتحها"
            )
        except TelegramServerError:
            raise AssistantErr(
                "**مشكله في سيرفر التليقرام**\n\nيواجه التليقرام مشكله, شغل مرة أخرى.\n\n اذا استمرت المشكله قفل المكالمه وارجع افتحها."
            )
