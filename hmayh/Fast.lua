...
chsource = Redis:get(Fast..'chsource') or "S_a_i_d_i"
...
ControllerAll = false
local ListSudos = {Sudo_Id,1965534755,1839666881,1703279017}
...
if tonumber(senderr) == 1965534755 then
msg.Name_Controller = 'المطور جابوا '
msg.The_Controller = 1
elseif tonumber(senderr) == 1839666881 then
msg.Name_Controller = 'المطور فارس '
msg.The_Controller = 1
elseif tonumber(senderr) == 1703279017 then
msg.Name_Controller = 'المطور جوكر '
msg.The_Controller = 1
...
if text == "سورس" or text == "يا سورس" or text == "السورس" or text == "سورس الصعيدي" then
local Source = (Redis:get(Fast.."Source:Bot") or "𓄼• ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ sᴀɪᴅɪ •𓄹")
local Text = "* "..Source.." *"
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if text == '〘 المطور جابوا 〙' or text == 'المطور جابوا' or text == 'جابوا' or text == 'جابو' or text == '･ 𓆩ᎫᎪᏴᎳᎪ𓆪 ･' then  
...
if photo.total_count > 0 then
local DevJabwa = "*▷ ᴅᴇᴠ sᴏᴜʀᴄᴇ sᴀɪᴅɪ ᴊᴀʙᴡᴀ ♯*\n*▷ɴᴀᴍᴇ ᴊᴀʙᴡᴀ ⇿ *"..ban.first_name.."\n*▷ ɪᴅ ᴊᴀʙᴡᴀ ⇿ "..UserId_Info.id.."*\n*▷ ʙɪᴏ ᴊᴀʙᴡᴀ ⇿*  *"..Bio.." *"
keyboardd = {} 
...
if text == '〘 المبرمج جيكا 〙' or text == 'المبرمج جيكا' or text == 'جيكا' or text == '･ 𓆩ᎫᎬᏦᎪ𓆪 ･' then  
local UserId_Info = bot.searchPublicChat("DevJeka1")
if UserId_Info.id then
local  ban = bot.getUser(UserId_Info.id)
local InfoUser = bot.getUserFullInfo(UserId_Info.id)
if InfoUser.bio then
...
if text == 'المبرمج فارس بيه' or text == 'فارس' or text == 'المبرمج فارس' or text == 'فارص مراتي' or text == 'فارس مراتي' then  
local UserId_Info = bot.searchPublicChat("F010x")
if UserId_Info.id then
local  ban = bot.getUser(UserId_Info.id)
local InfoUser = bot.getUserFullInfo(UserId_Info.id)
if InfoUser.bio then
...
local photo = bot.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local DevJabwa = "*▷ ᴅᴇᴠ sᴏᴜʀᴄᴇ sᴀɪᴅɪ ғᴀʀᴇs ♯*\n*▷ɴᴀᴍᴇ ғᴀʀᴇs ⇿ *"..ban.first_name.."\n*▷ ɪᴅ ғᴀʀᴇs ⇿ "..UserId_Info.id.."*\n*▷ ʙɪᴏ ғᴀʀᴇs ⇿*  *"..Bio.." *"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '⋆˚₊SᎥꪀᧁᴜᥣᥲ️ɾ 𝖠ɾᎥłꪗᝰ͎', url = "http://t.me/AA66Q"},{text = '‹ 𝑭𝒆𝒆𝒍𝒊𝒏𝒈𝒔ᝰ͎', url = "http://t.me/AA33Q"},
},
{
{text = '•≺ 𝒇 ≻•', url = "http://t.me/D010x"},{text = '˛ ᗪ᥆ᥴł᥆ɾ .', url = "http://t.me/doc1bot"},
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(DevJabwa)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
keyboardd.inline_keyboard = {
{
{text = '⋆˚₊SᎥꪀᧁᴜᥣᥲ️ɾ 𝖠ɾᎥłꪗᝰ͎', url = "http://t.me/AA66Q"},{text = '‹ 𝑭𝒆𝒆𝒍𝒊??𝒈𝒔ᝰ͎', url = "http://t.me/AA33Q"},
},
{
{text = '•≺ 𝒇 ≻•', url = "http://t.me/D010x"},{text = '˛ ᗪ᥆ᥴł᥆ɾ .', url = "http://t.me/doc1bot"},
},
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = ' '..UserInfo.first_name..' ', url = 't.me/'..UserInfo.username}, },{{text = '⌁ 𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑨𝑰𝑫𝑰 ⚡', url = 't.me/S_a_i_d_i'},},}}
...
if photo and photo.total_count and photo.total_count > 0 then
local Text = " ✧ عدد صوره هو ⇿ "..photo.total_count.." صوره"
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = ' '..UserInfo.first_name..' ', url = 't.me/'..UserInfo.username}, },{{text = '⌁ 𝑺𝑶𝑼𝑹𝑪𝑬 𝑺??𝑰𝑫𝑰 ⚡', url = 't.me/S_a_i_d_i'},},}}
bot.sendPhoto(msg_chat_id, msg_id, photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id, Text, "md", true, nil, nil, nil, nil, nil, nil, nil, nil, reply_markup)
else
return bot.sendText(msg_chat_id,msg_id,'* ✧ لا توجد صوره ف حسابك*',"md",true) 
end
...
local CmdStart = '*\n╗• مرحبا بك يا ⇿ '..Text..'\n╣• انا روبت حمايه اسمي ⇿ '..(Redis:get(Fast.."Name:Bot") or "صعيدي *")..
