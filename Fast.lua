...
send(data.chat_id,data.id,"◍ ااهلا بك مطوري الاساسي ⚡ \n","md",true, false, false, true, reply_markup)
return false 
end
if text == "/start" then
Redis:del(Fast..data.sender_id.user_id.."bottoken")
...
send(msg.chat_id,msg.id,'◍ ارسل الان معرف القناه ',"html",true)  
end
if text == "◍ تعطيل الاشتراك الاجباري" then
Redis:del(Fast.."ch:admin")
Redis:del(Fast.."chfalse")
send(msg.chat_id,msg.id,'◍ تم حذف القناه ',"html",true)  
end
