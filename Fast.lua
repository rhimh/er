...
data = {
{
{text = '⌔️ قسم الحماية',type = 'text'},{text = '⌔️ قسم الاغاني',type = 'text'},
},
}
}
...
if text == '⌔️ قسم الحماية' or text == '⌔️ قسم الاغاني' then
Redis:del(Fast..msg.sender_id.user_id.."botuoken")
Redis:del(Fast..msg.sender_id.user_id.."botuseriu")
Redis:del(Fast..msg.sender_id.user_id.."Fast:bot")
reply_markup = LuaTele.replyMarkup{type = 'keyboard',resize = true,is_personal = true,
data = {
{
{text = '⌔️ عدد بوتات الحمايه',type = 'text'},{text = '⌔️ عدد بوتات الميوزك',type = 'text'},
},
{
{text = '⌔️ صنع بوت',type = 'text'},{text = '⌔️ حذف بوت',type = 'text'},
},
{
...
{
{text = '⌔️ الاحصائيات',type = 'text'},{text = '⌔️ الاسكرينات المفتوحه',type = 'text'},
},
{
...
{
{text = '⌔️ تقرير البوتات',type = 'text'},{text = '⌔️ جلب نسخة الصانع',type = 'text'},
},
{
...
{
{text = '⌔️ الغاء الامر',type = 'text'},{text = 'رجوع↜',type = 'text'},
},
}
}
...
rqm = rqm + 1
message = message..rqm..' -> ⌔️  `'..screnName..' ` ⌔️ \n'
end
...
send(msg.chat_id,msg.id,"تم تحديث⌔️  "..#list.." ⌔️ بوت","html",true)  
end
...
local list = Redis:smembers(Fast..'3ddbots')
send(msg.chat_id,msg.id,"تم تشغيل⌔️  "..#list.." ⌔️ بوت","html",true)  
end
--------mange bots
...
send(msg.chat_id,msg.id,"⌔️ تم ايقاف⌔️  "..#list.." ⌔️ بوت \n عدد مجموعاتهم اقل من 2","html",true)
end
...
photo = "https://t.me/kliollo/26"
local list = Redis:smembers(Fast.."totaui")
local JABWA = "*⌔️ عدد مشتركين بوتك⌔️  "..#list.." ⌔️ مشترك*"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'مـصنع ارنـوب', url = 't.me/Y_H_U_0_BOT '},
},
}
...
send(msg.chat_id,msg.id,"⌔️ تمت الاذاعه الى *⌔️  "..#list.." ⌔️ * عضو في البوت ","md",true)      
Redis:del(Fast..msg.sender_id.user_id.."brodcast") 
return false
end
...
local list = Redis:smembers(Fast.."totaui") 
send(msg.chat_id,msg.id,"⌔️ تم التوجيه الى *⌔️  "..#list.." ⌔️ * مشترك ف البوت ","md",true)      
for k,v in pairs(list) do  
...
photo = "https://t.me/kliollo/26"
local T = "*⌔️ مرحبا انا بوت صانع بوتات\n⌔️ اقوم بصنع بوتات حمايه\n⌔️ واقوم بصنع بوتات ميوزك\n⌔️ انا خاص بفريق سورس ارنـوب\n⌔️ تم برمجتي من قبل مطورين السورس\n⌔️ للتنصيب الحمايه ارسل /AFYO  *"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'ժ᥎ ᥲ️ᖴY᥆ꪀᥲ', url = 't.me/Y_H_U_1 '},
},
{
{text = '˹ِٰ᥉᥆uɾᥴ︎ᥱ︎ ⌔️', url = 't.me/A_R_N_0 '},
},
}
local msgg = msg.id/2097152/0.5
...
data = {
{
{text = '⌔️ تشغيل البوت',type = 'text'},{text = '⌔️ ايقاف البوت',type = 'text'},
},
{
...
send(msg.chat_id,msg.id,"*⌔️ مرحبا اليك قسم صانع الحمايه ⌔️\n\n⌔️ قناة التحديثات (@A_R_N_0) ⌔️\n\n⌔️ جروب الدعم (@A_R_N0) ⌔️\n\n⌔️ مطور السورس (@Y_H_U_1) ⌔️*","md",true, false, false, true, reply_markup)
return false 
end
if text == '⌔️ طريقة صنع بوت' or text == 'مش شغال' or text == 'عاوز اعمل بوت' or text == 'عاوزه اعمل بوت' then
video = "https://t.me/A_R_N_0/3143"
local T =[[*
▱▰▱▰▱▰▱▰▱▰▱▰▱▰
...
keyboard.inline_keyboard = {
{
{text = 'ժ᥎ ᥲ️ᖴY᥆ꪀᥲ', url = "https://t.me/Y_H_U_1"}
},
{  
{text = '᥉᥆uɾᥴ︎ᥱ︎ ⌔️', url = 't.me/A_R_N_0 '},
},
}
local msgg = msg.id/2097152/0.5
...
if text == 'سورس' or text == '⌔️ سورس' or text == 'يا سورس' or text == 'source' or text == 'ارنوب' then
photo = "https://t.me/kliollo/26"
local T =[[
 [𓄼• ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ ᴠᴇɢᴀ •𓄹](t.me/A_R_N_0 )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if text == 'افيونا' or text =='مبرمج السورس' or text == '⌔️ مبرمج السورس' then  
local UserId_Info = bot.searchPublicChat("Y_H_U_1")
...
local TestText = "*ժ᥎ ᥲ️ᖴY᥆ꪀᥲ\n𝑛𝑎𝑚𝑒* ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n*ႦᎥρ "..Bio.." *"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = username, url = "https://t.me/Y_H_U_1"}
},
}
...
keyboard.inline_keyboard = {
{
{text = Text, url = 't.me/Y_H_U_0_BOT '},
},
}
local msgg = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo="..photo.."&caption=".. URL.escape(JABWA).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
